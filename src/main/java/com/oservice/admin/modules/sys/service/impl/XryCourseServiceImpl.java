...
public class XryCourseServiceImpl extends ServiceImpl<XryCourseDao, XryCourseEntity> implements XryCourseService {
    ...
    @Override
    public List<XryCourseCatalogEntity> queryCourseCatalogByCourseId(Long id) {
...
//            Long orgId = teacher.getOrgId();
    ...
    public Map<String, Object> listCourseCommentByCourseId(Long courseId,Integer pageNo, Integer pageSize, String userId) {
        ...
        Integer courseCommentCount = baseMapper.countCourseCommentByCourseId(map);
        params.put("courseCommentCount", courseCommentCount);
    ...
    @Override
    public List<Map<String, Object>> listRecommendCourse(Map<String, Object> params) {
        return baseMapper.listRecommendCourse(params);
    }

    @Override
    public List<Map<String, Object>> listUserSettingCourseByUserId(Map<String, Object> params) {
        return baseMapper.listUserSettingCourseByUserId(params);
    }
